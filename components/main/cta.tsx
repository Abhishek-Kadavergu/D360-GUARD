...
export const Cta = () => {
  return (
    <section className="flex flex-col items-center justify-center py-16 sm:py-20 md:py-32 px-4 sm:px-6 md:px-8 text-center z-[20]">
      <h2 className="text-2xl sm:text-3xl md:text-[40px] lg:text-[50px] font-semibold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500 mb-4 sm:mb-5 md:mb-6 leading-tight">
        Adopt AI With Confidence.
      </h2>
      <p className="text-gray-300 text-sm sm:text-base md:text-lg lg:text-xl max-w-[700px] mb-6 sm:mb-8 md:mb-10 leading-relaxed">
