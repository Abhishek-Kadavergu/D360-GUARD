      ...
      <div className="w-full flex-col items-center justify-center mt-20 z-[20]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-10 max-w-7xl mx-auto">
          {FEATURE_CARDS.map((feature, idx) => (
            <div key={idx} className="relative overflow-hidden rounded-xl border border-[#7042f88b] bg-[#0300145e] backdrop-blur-md p-6 group hover:border-purple-500 transition-colors">
