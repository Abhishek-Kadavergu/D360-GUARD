  ...
  return (
    ...
    >
      ...
      <div className="relative p-4 sm:p-5 flex flex-col flex-grow">
        <h3 className="text-base sm:text-lg font-semibold text-white mb-1.5 sm:mb-2 line-clamp-1">{title}</h3>
        <p className="text-xs sm:text-sm text-gray-400 leading-relaxed line-clamp-3">{description}</p>
      </div>
    </Link>
  );
};
